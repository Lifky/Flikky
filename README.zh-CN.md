...
| 通道 | 版本 | 状态                                                                           |
| --- | --- |------------------------------------------------------------------------------|
| 稳定版源码 | [`v1.20.0`](https://github.com/Lifky/Flikky/tree/v1.20.0) · 2026-09-13 | 手机存储在两端均可浏览（受默认关闭的开关门控），每个文件界面都有排序与目录内搜索，缩略图与预览覆盖存储列表与收藏面板，行首容器的形状与配色可定制。 |
| `main` | [未发布改动](https://github.com/Lifky/Flikky/compare/v1.20.0...main) | 稳定 tag 之外暂无未发布改动。                                                            |
