<p align="center">
  <img src="./docs/flikky_logo_slow.svg" width="256" alt="Flikky 图标">
</p>

<h1 align="center">Flikky</h1>

<p align="center">
  <em>“Flikky 像聊天一样助您自由传输”</em>
</p>
...
收藏（代号：弹药箱）：您可以将**任何消息或本地文件**转化为收藏，如果是文件，它将被**独立存储**，您在外部删除不会影响收藏。收藏将在您需要发送时时刻准备着。*由于手机存储空间比较大，以至于后来我把它当做**移动U盘**来使用了。*
