...
| 通道 | 版本 | 状态 |
| --- | --- | --- |
| 稳定版源码 | [`v1.19.0`](https://github.com/Lifky/Flikky/tree/v1.19.0) · 2026-08-26 | 浏览器端以 Material 3 Expressive 重做（三段式外壳 + 窄屏底部导航），新增浏览器端收藏与设置面板，会话中快捷设置覆盖全部双端同步项。 |
| `main` | [未发布改动](https://github.com/Lifky/Flikky/compare/v1.19.0...main) | 稳定 tag 之外暂无未发布改动。 |
...
- **自适应外观**：Material 3 Expressive 主题、自定义主题色、深色模式、对比度、动画速度、头像（含浏览器端头像）、气泡形状与头像分组等设置可在手机与浏览器之间保持一致。
