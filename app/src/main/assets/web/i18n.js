(function () {
    const translations = {
        'zh-CN': {
            ...
            'login.submit': '进入',
            'login.privacy_tip': '提示：为防止浏览器插件读取会话内容，建议使用无痕/隐私窗口访问。',
        ...
        en: {
            ...
            'login.privacy_tip': 'Tip: Use an incognito or private window to prevent browser extensions from reading session content.',
