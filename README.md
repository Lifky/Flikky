...
- The bubble corner-radius slider applies on the phone only; the browser uses a static 18px. Two-end **color** theme sync (seed + light/dark) landed in v1.11.0, but corner radius is not yet synced. *(still open after v1.11.0)*
