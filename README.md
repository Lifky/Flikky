<p align="center">
  <img src="./docs/flikky_logo_slow.svg" width="256" alt="Flikky logo">
</p>

<h1 align="center">Flikky</h1>

<p align="center">
  <em>"Flikky helps you freely transfer files just like chatting"</em>
</p>
...
Favorites (code name: Ammo Box): You can turn **any message or local file** into a favorite. If it's a file, it will be **stored independently**, so deleting it externally won't affect the favorite. Your favorites are always ready when you need to send them. *Since my phone has plenty of storage space, I later started using it as a **portable USB drive**.*
